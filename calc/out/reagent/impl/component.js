...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__663 = c;
var G__663__$1 = (((G__663 == null))?null:G__663.prototype);
if((G__663__$1 == null)){
return null;
} else {
return G__663__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__664 = c;
var G__664__$1 = (((G__664 == null))?null:G__664.prototype);
if((G__664__$1 == null)){
return null;
} else {
return G__664__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__672 = c;
var G__672__$1 = (((G__672 == null))?null:G__672.constructor);
if((G__672__$1 == null)){
return null;
} else {
return G__672__$1.displayName;
}
})();
...
var G__673 = c;
var G__673__$1 = (((G__673 == null))?null:G__673.constructor);
if((G__673__$1 == null)){
return null;
} else {
return G__673__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__674 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__675 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__675);

try{return reagent.impl.component.wrap_render.call(null,c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__674);
}});
...
reagent.impl.batching.mark_rendered.call(null,component_state);

var G__676 = reagent.impl.component.goog$module$goog$object.get.call(null,component_state,"cljsRatom");
if((G__676 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__676);
}
} else {
return null;
}
...
var G__677 = key;
var G__677__$1 = (((G__677 instanceof cljs.core.Keyword))?G__677.fqn:null);
switch (G__677__$1) {
...
var c = this;
reagent.impl.component.cancel_cleanup.call(null,c);
...
var c = this;
reagent.impl.component.queue_cleanup.call(null,c);
...
var renders_680 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_681 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_680));
...
if((cljs.core.count.call(null,renders_680) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_680))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_681)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_681)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__682 = o;
reagent.impl.component.goog$module$goog$object.set.call(null,G__682,cljs.core.name.call(null,k),v);
...
return (function() { 
var G__683__delegate = function (args){
return reagent.impl.protocols.as_element.call(null,compiler,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__683 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__684__i = 0, G__684__a = new Array(arguments.length -  0);
while (G__684__i < G__684__a.length) {G__684__a[G__684__i] = arguments[G__684__i + 0]; ++G__684__i;}
  args = new cljs.core.IndexedSeq(G__684__a,0,null);
} 
return G__683__delegate.call(this,args);};
G__683.cljs$lang$maxFixedArity = 0;
G__683.cljs$lang$applyTo = (function (arglist__685){
var args = cljs.core.seq(arglist__685);
return G__683__delegate(args);
});
G__683.cljs$core$IFn$_invoke$arity$variadic = G__683__delegate;
return G__683;
})()
...
var _STAR_current_component_STAR__orig_val__688 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__689 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__689);

try{return reagent.impl.component.functional_wrap_render.call(null,compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__688);
}});
...
var vec__690 = reagent.impl.component.global$module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.call(null,vec__690,(0),null);
var force_update = cljs.core.nth.call(null,vec__690,(1),null);
...
reagent.impl.component.cancel_cleanup.call(null,reagent_state);

return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
return reagent.impl.component.queue_cleanup.call(null,reagent_state);
});
}),[]);
...
return reagent.impl.component.global$module$react.memo(f,reagent.impl.component.functional_render_memo_fn);
});

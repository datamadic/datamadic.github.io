...
var G__706 = shadow_root.activeElement;
active_element = G__706;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__707){
var map__708 = p__707;
var map__708__$1 = cljs.core.__destructure_map.call(null,map__708);
var on_write = cljs.core.get.call(null,map__708__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5045__auto__ = (!((((node === reagent.impl.input.get_true_active_element.call(null))) && (((reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5045__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__709 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__710 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__710);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__709);
}}));
} else {
...
(jsprops.onChange = (function (p1__711_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__711_SHARP_);
}));

...
var G__674 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__674;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__675 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__675,ch);
...
if(("\\" === ch__$1)){
var ch_676__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_676__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_676__$2);
} else {
}

var G__677 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__677;
continue;
}
}
...
var vec__685 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__685,(0),null);
var start_column = cljs.core.nth.call(null,vec__685,(1),null);
...
var G__688 = cljs.core.conj_BANG_.call(null,a,form);
a = G__688;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__689 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__690 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__690);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__689);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__691 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__691,(0),null);
var start_column = cljs.core.nth.call(null,vec__691,(1),null);
...
var vec__694 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__694,(0),null);
var end_column = cljs.core.nth.call(null,vec__694,(1),null);
...
var vec__697 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__697,(0),null);
var start_column = cljs.core.nth.call(null,vec__697,(1),null);
...
var vec__700 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__700,(0),null);
var end_column = cljs.core.nth.call(null,vec__700,(1),null);
...
var vec__703 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__703,(0),null);
var start_column = cljs.core.nth.call(null,vec__703,(1),null);
...
var vec__706 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__706,(0),null);
var end_column = cljs.core.nth.call(null,vec__706,(1),null);
...
var sb = (function (){var G__709 = (new goog.string.StringBuffer());
G__709.append(initch);
...
var G__711 = (function (){var G__710 = sb;
G__710.append(ch);

return G__710;
})();
var G__712 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__711;
ch = G__712;
continue;
}
...
switch (G__715) {
case "\\":
var G__719 = (function (){var G__716 = sb;
G__716.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__716;
})();
var G__720 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__719;
ch = G__720;
continue;
...
break;
default:
var G__721 = (function (){var G__717 = sb;
G__717.append(ch);
...
var vec__723 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__723,(0),null);
var end_column = cljs.core.nth.call(null,vec__723,(1),null);
...
var vec__726 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__726,(0),null);
var column = cljs.core.nth.call(null,vec__726,(1),null);
...
var vec__731 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__731,(0),null);
var column = cljs.core.nth.call(null,vec__731,(1),null);
...
var vec__736 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__736,(0),null);
var column = cljs.core.nth.call(null,vec__736,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__741 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__741,(0),null);
var start_column = cljs.core.nth.call(null,vec__741,(1),null);
...
var vec__744 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__744,(0),null);
var end_column = cljs.core.nth.call(null,vec__744,(1),null);
...
var G__747 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__747,true,null,opts,pending_forms);
...
var G__748 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__748)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__748)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__748)){
...
var _STAR_suppress_read_STAR__orig_val__749 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__750 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__750);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__749);
}});
...
var G__751 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__751,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__751,rdr,first_line);
...
var G__755 = matched;
var G__756 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__755;
finished = G__756;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__757 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__758 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__758);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__757);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__759 = cljs.tools.reader.arg_env;
var arg_env_temp_val__760 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__760);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__761 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__761,"(");
...
var G__762 = (i + (1));
var G__763 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5045__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__759);
}});
/**
...
var ch = temp__5823__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__764 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__764);
...
var G__765 = cljs.core.next.call(null,s__$1);
var G__766 = ret;
s__$1 = G__765;
r = G__766;
continue;
...
var G__767 = cljs.core.next.call(null,s);
var G__768 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__767;
key_vals = G__768;
continue;
} else {
...
var gensym_env_orig_val__771 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__772 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__772);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__771);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__773 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__773,(0),null);
var start_column = cljs.core.nth.call(null,vec__773,(1),null);
...
var temp__5823__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__776 = token;
var G__776__$1 = (((G__776 == null))?null:cljs.core.subs.call(null,G__776,(1)));
var G__776__$2 = (((G__776__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__776__$1));
var G__776__$3 = (((G__776__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__776__$2));
var G__776__$4 = (((G__776__$3 == null))?null:cljs.core.symbol.call(null,G__776__$3));
if((G__776__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__776__$4);
}
})():(function (){var G__777 = token;
var G__777__$1 = (((G__777 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__777));
if((G__777__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__777__$1);
}
})()
));
if(cljs.core.truth_(temp__5823__auto__)){
...
var vec__778 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__778,(0),null);
var end_column = cljs.core.nth.call(null,vec__778,(1),null);
...
var temp__5823__auto__ = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}catch (e787){if((e787 instanceof Error)){
var e = e787;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__791,reader){
var map__792 = p__791;
var map__792__$1 = cljs.core.__destructure_map.call(null,map__792);
var opts = map__792__$1;
var eof = cljs.core.get.call(null,map__792__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));

...
var seq__1624_1628 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1625_1629 = null;
var count__1626_1630 = (0);
var i__1627_1631 = (0);
while(true){
if((i__1627_1631 < count__1626_1630)){
var str_1632 = cljs.core._nth.call(null,chunk__1625_1629,i__1627_1631);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1632})));


var G__1633 = seq__1624_1628;
var G__1634 = chunk__1625_1629;
var G__1635 = count__1626_1630;
var G__1636 = (i__1627_1631 + (1));
seq__1624_1628 = G__1633;
chunk__1625_1629 = G__1634;
count__1626_1630 = G__1635;
i__1627_1631 = G__1636;
continue;
} else {
var temp__5825__auto___1637 = cljs.core.seq.call(null,seq__1624_1628);
if(temp__5825__auto___1637){
var seq__1624_1638__$1 = temp__5825__auto___1637;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1624_1638__$1)){
var c__5568__auto___1639 = cljs.core.chunk_first.call(null,seq__1624_1638__$1);
var G__1640 = cljs.core.chunk_rest.call(null,seq__1624_1638__$1);
var G__1641 = c__5568__auto___1639;
var G__1642 = cljs.core.count.call(null,c__5568__auto___1639);
var G__1643 = (0);
seq__1624_1628 = G__1640;
chunk__1625_1629 = G__1641;
count__1626_1630 = G__1642;
i__1627_1631 = G__1643;
continue;
} else {
var str_1644 = cljs.core.first.call(null,seq__1624_1638__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1644})));


var G__1645 = cljs.core.next.call(null,seq__1624_1638__$1);
var G__1646 = null;
var G__1647 = (0);
var G__1648 = (0);
seq__1624_1628 = G__1645;
chunk__1625_1629 = G__1646;
count__1626_1630 = G__1647;
i__1627_1631 = G__1648;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1653 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1653,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1653,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1653,"onreadystatechange",onload);

return G__1653;
})();
if((opt_sourceText == null)){
var G__1654 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1654,"src",src);

return G__1654;
} else {
var G__1655 = script__$1;
goog.dom.setTextContent(G__1655,opt_sourceText);
...
var path_1656 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_1656);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1656)].join(''));
} else {
var path_1657 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_1657);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_1657);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1657)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1658 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1659 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1659);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1658);
}})()})));
}));
